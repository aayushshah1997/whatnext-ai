...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, SafeAreaView, Platform, Image, Animated } from 'react-native';
            ...
            {games.map((game, index) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    styles.gameCard,
                    isSloppyBirds && styles.featuredGameCard
                  ]}
                  onPress={() => {
                    if (game.route) {
                      router.push(game.route);
                    } else {
                      // For games that are not yet implemented
                  ...
                  <View style={styles.gameInfo}>
                    <Text style={[
                      styles.gameName,
                      isSloppyBirds && styles.featuredGameName
                    ]}>{game.name}</Text>
                    <Text style={[
                      styles.gameDescription,
                      isSloppyBirds && styles.featuredGameDescription
